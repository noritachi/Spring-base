...
public class ErrorCode {
    ...
    /**
     * Starting error code Article
     * */
    public static final String ARTICLE_ERROR_NOT_FOUND = "ERROR-ARTICLE-0000";
    public static final String ARTICLE_ERROR_EXISTED = "ERROR-ARTICLE-0001";

    /**
     * Starting error code Video
     * */
    public static final String VIDEO_ERROR_NOT_FOUND = "ERROR-VIDEO-0000";
    public static final String VIDEO_ERROR_EXISTED = "ERROR-VIDEO-0001";

    /**
     * Starting error code Quiz
     * */
    public static final String QUIZ_ERROR_NOT_FOUND = "ERROR-QUIZ-0000";
    public static final String QUIZ_ERROR_EXISTED = "ERROR-QUIZ-0001";
    /**
